...
function prototype:initData(PlayId)
	...
	local aniPathTex=""
	local aniName=""
	if self.playId == 115001 then
		aniPathDbbin="resource/Longhudou/csbimages/GoldItem/szdantiaotwo_ske.dbbin"
		aniPathTex="resource/Longhudou/csbimages/GoldItem/szdantiaotwo_tex.json"
		aniName="szdantiaotwo"
	else
		aniPathDbbin="resource/Longhudou/csbimages/GoldItem/szdantiaofive_ske.dbbin"
		aniPathTex="resource/Longhudou/csbimages/GoldItem/szdantiaofive_tex.json"
...
function prototype:onBtnItemClick(sender, eventType)
	if self.playId == 115001 then
		Model:get("Games/Longhudou"):requestEnterRoom(115001, 110)
	else
		Model:get("Games/Longhudou"):requestEnterRoom(115002, 110)
	end
end
