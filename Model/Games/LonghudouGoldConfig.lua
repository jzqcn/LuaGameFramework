...
require "Protol.LonghudouGoldConfig_pb"
...
function class:initialize()
    ...
    net.msg:on(MsgDef_pb.MSG_LONGHUDOU_GOLD_CONFIG, self:createEvent("onGoldConfigData")) 
end

function class:requestGetLevelConfig(typeId)
	local request = LonghudouGoldConfig_pb.LonghudouGoldConfigRequest()
	request.typeId = typeId
	net.msg:send(MsgDef_pb.MSG_LONGHUDOU_GOLD_CONFIG, request:SerializeToString())
end
...
function class:onGoldConfigData(data)
	...
	local response = LonghudouGoldConfig_pb.LonghudouGoldConfigResponse()
