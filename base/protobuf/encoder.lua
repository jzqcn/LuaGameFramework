...
--liuw
function GroupEncoder(field_number, is_repeated, is_packed)
    assert(false, "encoder type error --> GroupEncoder")
end

function GroupSizer(field_number, is_repeated, is_packed)
    assert(false, "encoder type error --> GroupSizer")
end