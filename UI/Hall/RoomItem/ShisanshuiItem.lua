...
function prototype:enter()
	...
	factory:loadDragonBonesData("resource/csbimages/Hall/RoomItem/shisanshui_item_ske.dbbin", "shisanshui_item")
    factory:loadTextureAtlasData("resource/csbimages/Hall/RoomItem/shisanshui_item_tex.json", "shisanshui_item")
    local itemAnimation = factory:buildArmatureDisplay("Armature", "shisanshui_item")
...
function prototype:exit()
	...
	if self.itemAnimation then
		...
		dragonBones.CCFactory:getFactory():removeDragonBonesData("shisanshui_item")
		dragonBones.CCFactory:getFactory():removeTextureAtlasData("shisanshui_item")
	end	
end
