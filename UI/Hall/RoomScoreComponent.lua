...
function prototype:enter()
	...
	for i=1,3 do
		local armatureName = string.format("hall_woman_%d",i)
		local BonesData = string.format("resource/csbimages/Hall/ComponentRoom/woman_%d_ske.dbbin",i)
		local TextureAtlasData = string.format("resource/csbimages/Hall/ComponentRoom/woman_%d_tex.json",i)
